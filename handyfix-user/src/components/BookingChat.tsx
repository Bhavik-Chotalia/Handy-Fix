...
const BookingChat = ({ bookingId, currentUserId, senderType }: BookingChatProps) => {
  ...
  useEffect(() => {
    ...
    const unreadField = senderType === "customer" ? "unread_messages_customer" : "unread_messages_provider";
    ...
    <div className="flex flex-col h-[380px] overflow-hidden">
      ...
      <div className="p-3 border-t border-border flex gap-2 bg-card/50">
        ...
        <Button
          ...
          size="sm"
          className="bg-gradient-gold text-primary-foreground rounded-xl px-4 h-10"
        >
