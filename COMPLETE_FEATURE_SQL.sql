-- ════════════════════════════════════════════════════════════════════════════
-- HandyFix COMPLETE FEATURE SQL
-- Run this in Supabase SQL Editor (project rmjbkuorbfcaeplftnfe)
-- ════════════════════════════════════════════════════════════════════════════

-- ════════════════════════════════════════════════════════════════════════════
-- 1. FIX: Booking RLS — provider can see their own bookings, customer can see theirs
-- ════════════════════════════════════════════════════════════════════════════
...
CREATE POLICY "providers_view_own_bookings"
...
CREATE POLICY "providers_update_own_bookings"
...
-- ════════════════════════════════════════════════════════════════════════════
-- 2. ADD: Provider custom pricing per service
-- ════════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════════
-- 3. ADD: Service sub-categories (Urban Company style)
-- ════════════════════════════════════════════════════════════════════════════
...
-- Add sub-item tracking columns to bookings
...
-- ════════════════════════════════════════════════════════════════════════════
-- 4. SEED: Sub-items for all 8 services
-- ════════════════════════════════════════════════════════════════════════════

-- AC Service
INSERT INTO public.service_sub_items (service_id, name, description, base_price, duration_minutes, icon, sort_order)
SELECT s.id, sub.name, sub.description, sub.price, sub.duration, sub.icon, sub.sort_order
...
) AS sub(name, description, price, duration, icon, sort_order)
...
-- ════════════════════════════════════════════════════════════════════════════
-- 5. VERIFY: Count sub-items per service
-- ════════════════════════════════════════════════════════════════════════════
SELECT s.name AS service, s.slug, COUNT(si.id) AS sub_item_count
FROM public.services s
